        ...
        <header>
            <section class="Barra_Navegacion">
                ...
                <nav id="menu">
                    <ul>
                        ...
                        <li><a href="../Agendamiento_citas.html" class="menu">Citas</a></li>
                        <li><a href="formularios/induccion.html" class="menu">Formularios</a></li>
                        <li><a href="contratos/Contrato_Fijo.html" class="menu">Contratos</a></li>
                    </ul>
                </nav>
            </section>
            <div id="Barra_Herramientas">
                <ul class="Herramientas">
                    ...
                    <li><a href="registrar_aspirante">Nuevo Aspirante</a></li>
                </ul>
            </div>
        </header>
<!--===============================================================================================================-->
        ...
        <section class="contenido">
            <section class="Perfil_Aspirante">
                ...
                <section class="Documentos_Aspirante">
                    ...
                    <input type="submit" name="Boton_Documento" class="Boton_Documento" value="Documento 1" id="Documento_1P">
                    <input type="submit" name="Boton_Documento" class="Boton_Documento" value="Documento 2">
                    <input type="submit" name="Boton_Documento" class="Boton_Documento" value="Documento 3">
                    <input type="submit" name="Boton_Documento" class="Boton_Documento" value="Documento n">
            ...
            <section class="Perfil_Aspirante">
                ...
                <section class="Documentos_Aspirante">
                    <p><a href="../aspirantes/Perfil_Aspirante.html">Nombre Aspirante</a></p>
                    <input type="submit" name="Boton_Documento" class="Boton_Documento" value="Documento 1">
                    <input type="submit" name="Boton_Documento" class="Boton_Documento" value="Documento 2">
                    <input type="submit" name="Boton_Documento" class="Boton_Documento" value="Documento 3">
                    <input type="submit" name="Boton_Documento" class="Boton_Documento" value="Documento n">
                    <input class="botons" type="submit" name="Bloqueo" value="Bloquear" id="Botón_Bloqueo">
